...
public class DatabaseManager {
    ...
    public void init() {
        ...
        hc.setMaxLifetime(1_200_000);  // 20 min
    ...
    /** Load the latest snapshot for a player (payload + DB timestamp). */
    ...
    /** Upsert the snapshot for a player. updated_at is handled by MySQL. */
